...
namespace HansOS.Api.Migrations
{
    ...
    public partial class AddTodoEntities : Migration
    {
        ...
        {
            // 移除舊版 Todo 模組表（由 AddTodoModule migration 建立）
            // 以新版 TodoProjects + TodoItems (簡化 schema) 取代
            migrationBuilder.DropTable(name: "TodoChecklistItems");
            migrationBuilder.DropTable(name: "TodoItemRelations");
            migrationBuilder.DropTable(name: "TodoItemTodoTag");
            migrationBuilder.DropTable(name: "TodoItems");
            migrationBuilder.DropTable(name: "TodoTags");
            migrationBuilder.DropTable(name: "TodoCategories");
        ...
        {
            migrationBuilder.DropTable(name: "TodoItems");
            migrationBuilder.DropTable(name: "TodoProjects");
        }
    }
}
