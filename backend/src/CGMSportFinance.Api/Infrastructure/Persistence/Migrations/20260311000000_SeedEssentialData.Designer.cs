...
namespace CGMSportFinance.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260311000000_SeedEssentialData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CGMSportFinance.Api.Infrastructure.Identity.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CGMSportFinance.Api.Infrastructure.Identity.Menu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CGMSportFinance.Api.Infrastructure.Identity.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CGMSportFinance.Api.Infrastructure.Identity.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CGMSportFinance.Api.Infrastructure.Identity.Menu", b =>
                {
                    b.HasOne("CGMSportFinance.Api.Infrastructure.Identity.Menu", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("CGMSportFinance.Api.Infrastructure.Identity.RoleMenu", b =>
                {
                    b.HasOne("CGMSportFinance.Api.Infrastructure.Identity.Menu", "Menu")
                        .WithMany("RoleMenus")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CGMSportFinance.Api.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
