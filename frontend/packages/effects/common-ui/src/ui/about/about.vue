...
withDefaults(defineProps<Props>(), {
  description:
    '是一个现代化开箱即用的中后台解决方案，采用最新的技术栈，包括 Vue 3.0、Vite、TailwindCSS 和 TypeScript 等前沿技术，程式碼规范严谨，提供丰富的配置選項，旨在为中大型專案的开发提供现成的开箱即用解决方案及丰富的示例，同时，它也是学习和深入前端技术的一个极佳示例。',
  name: 'Vben Admin',
  title: '关于專案',
});
...
<template>
  <Page :title="title">
    ...
    <div class="card-box mt-6 p-5">
      <div>
        <h5 class="text-lg text-foreground">生产环境依賴</h5>
      </div>
      <div class="mt-4">
        <dl class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
    ...
    <div class="card-box mt-6 p-5">
      <div>
        <h5 class="text-lg text-foreground">开发环境依賴</h5>
      </div>
      <div class="mt-4">
        <dl class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
